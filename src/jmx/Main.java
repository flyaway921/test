...
public class Main {
	...
	NullPointerException {
		...
		mbs.registerMBean(controller, new ObjectName(
				"MyappMBean:name=controller"));
		
		mbs.registerMBean(new Controller(), new ObjectName("MyappMBean:name=hi"));
...
class MyString implements ControllerMBean{
